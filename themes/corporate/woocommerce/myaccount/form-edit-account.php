...
?>
<form class="woocommerce-EditAccountForm edit-account corporate-edit-account" action="" method="post" <?php do_action( 'woocommerce_edit_account_form_tag' ); ?>>
    <?php do_action( 'woocommerce_edit_account_form_start' ); ?>

    <p class="woocommerce-form-row woocommerce-form-row--first form-row form-row-first">
        <label for="account_first_name">Ім'я <span class="required" aria-hidden="true">*</span></label>
    ...
    <p class="woocommerce-form-row woocommerce-form-row--last form-row form-row-last">
        <label for="account_last_name">Прізвище <span class="required" aria-hidden="true">*</span></label>
    ...
    <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
        <label for="account_display_name">Ім'я для відображення <span class="required" aria-hidden="true">*</span></label>
        ...
        <span><em>Так ваше ім'я відображатиметься в кабінеті та у відгуках.</em></span>
    </p>
    <div class="clear"></div>

    <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
        <label for="account_email">Електронна пошта <span class="required" aria-hidden="true">*</span></label>
    ...
    <fieldset>
        ...
        <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
            <label for="password_2">Підтвердьте новий пароль</label>
    ...
    <p>
        ...
        <button type="submit" class="woocommerce-Button button btn btn-buy-now" name="save_account_details" value="Зберегти зміни">Зберегти зміни</button>
